...
#define LCD_GAP_Y           0      // 行偏移（物理像素对应 GRAM 第 80~319 行，即底部 240 行）

/* ------------------------------------------------------------------
 * 屏幕旋转角度（0 / 90 / 180 / 270，逆时针）
 * ------------------------------------------------------------------ */
#define LCD_ROTATION        270     // 270 = 向右转90°

/* ------------------------------------------------------------------
 * 全息棱镜镜像标志（现场可调）
 * ------------------------------------------------------------------ */
#define MIRROR_X            0       // 1 = 水平镜像（左右翻转）
 ...
 *  15. 菜单参数
 * ================================================================ */
#define DEFAULT_STARTUP_MODE  MODE_MENU   /* 启动默认模式：MODE_PET 或 MODE_MENU */
